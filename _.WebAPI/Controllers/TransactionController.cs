...
public class TransactionController : ControllerBase
{
    ...
    public async Task<IActionResult> MakeTransaction(MakeTransactionRequest request)
    {
        try
        {
            ...
            if (!transactionStatus)
                return new JsonResult("Transaction Failed Due To An Internal Error") { StatusCode = 500 };
        ...
        catch (Exception e)
        {
            ...
            return new JsonResult("Transaction Failed Due To An Internal Error | Transaction Was Not Made")
                { StatusCode = 500 };
        }
    }
    ...
    {
        return Ok(await _unitOfWork.Transactions.GetRecentTransactions(null));
    }
}